...
> **Status:** v0.2 and v0.3 work described here has been completed. This document is retained as a record of the dependency/parallelization strategy that was used; it is not the current backlog. See [Roadmap to v0.3](roadmap.md) for delivered milestone evidence.
